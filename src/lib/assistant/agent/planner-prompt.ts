...
export const ASSISTANT_ACTION_CAPABILITY_GUIDANCE = [
  ...
  'Do not force unsupported requests into create_announcement, create_event, create_message, or create_email just because the topic mentions an event or needs copy.',
...
export const buildAssistantPlannerPrompt = ({
  ...
  [
    ...
    'Supported action types: create_announcement, update_announcement, create_event, update_event, create_message, create_email.',
