...
export const ASSISTANT_ACTION_CAPABILITY_GUIDANCE = [
  ...
  '- update_message: draft or plan edits to the active in-app message draft. Use this only for revising the active draft, not for editing already-sent messages.',
  '- create_email: draft or plan filling the email tab composer with an email subject and body for members. This prepares the draft only and does not send the email automatically.',
  '- update_email: draft or plan edits to the active email draft in the email tab composer. Use this only for revising the active draft.',
  'Prefer create_email over create_message when the user explicitly asks for an email, mentions the email tab or composer, or asks for a subject and body.',
  ...
  'If recent_history includes assistant_state: draft_preview or assistant_state: awaiting_confirmation for a message draft and the current message is a short editorial follow-up about that draft, classify it as update_message.',
  'If recent_history includes assistant_state: draft_preview or assistant_state: awaiting_confirmation for an email draft and the current message is a short editorial follow-up about that draft, classify it as update_email.',
  ...
  'Do not force unsupported requests into create_announcement, create_event, create_message, create_email, update_message, or update_email just because the topic mentions an event or needs copy.',
...
export const buildAssistantPlannerPrompt = ({
  ...
  [
    ...
    'Supported action types: create_announcement, update_announcement, create_event, update_event, create_message, update_message, create_email, update_email.',
    ...
    'Do not populate title, subject, body, description, location, date, or time. Those fields are generated later from the user message and recent history.',
